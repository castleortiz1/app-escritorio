...
from app.schemas import DemandPredictionRequest, ReorderRequest, SalesPoint, SlowMoversRequest
from app.services import detect_slow_movers, predict_demand, recommend_reorder
